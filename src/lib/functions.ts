...
export function getIconUrlByName(iconName: MaterialIcon, iconsUrl: string): string {
...
export function getIconInfo(name: MaterialIcon): MaterialIconInfo {
	...
	const folderNamesExpanded = findKeysByValue(name, iconMap.folderNamesExpanded);
